...
public class LinkedHashMapCustomApp {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("key 21=" + linkedHashMapCustom.get(21));
        System.out.println("51=" + linkedHashMapCustom.get(51));

        System.out.print("Displaying : ");
        linkedHashMapCustom.display();

        System.out.println("21 removed: " + linkedHashMapCustom.remove(21));
        System.out.println(" 22 removed: " + linkedHashMapCustom.remove(22));
